...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        list.add(Model("Rails", "Ruby on Rails is a server-side web application development framework written in Ruby language.", R.drawable.rail))
        list.add(Model("Python", "Python is interpreted scripting and object-oriented programming language.", R.drawable.py))
        list.add(Model("JavaScript", "JavaScript is an object-based scripting language.", R.drawable.js))
